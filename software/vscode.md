...
|[Debugger for Chrome](https://marketplace.visualstudio.com/items?itemName=msjsdiag.debugger-for-chrome)<br>`msjsdiag.debugger-for-chrome`|Permet de déboguer du JS exécuté dans Chrome, au sein de VS Code (existe aussi pour Firefox et Edge)|
